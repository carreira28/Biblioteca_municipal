...
public class Reserva {
    ...
    public String toString() {
        ...
        return String.format("[%d] %s | Req: %s | Saida: %s | Prev: %s | Dev: %s | %s", this.id, this.tituloLivro, this.nomeRequisitante, this.dataSaida, this.dataDevPrevista, devReal, alerta);
    }
}